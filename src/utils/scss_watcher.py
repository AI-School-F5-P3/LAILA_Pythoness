...
if __name__ == "__main__":
    scss_directory = "frontend/static/scss"  # Cambia esto al directorio de tus archivos SCSS
    css_directory = "frontend/static/css"   # Cambia esto al directorio de salida de CSS
